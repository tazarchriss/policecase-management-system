    ...
    if ($conn->query($sql) === TRUE) {
       ...
       VALUES (NULL, '$last_id', '$id', '$cfname', '$cphone', '$occupation')";
        ...
        if (mysqli_query($conn, $query)) {
            echo "<script>alert('Accuser Registered succeeded'); window.location='index.php'</script>";
        } else {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><i class="fa fa-laptop"></i>Register Accuser</li>
                </ol>
            </div>
        </div>
                            ...
                            <form class="form-validate form-horizontal " id="register_form" method="POST" action="">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        <button class="btn btn-primary" type="submit" name="accuser">Save</button>
