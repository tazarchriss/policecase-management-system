...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><i class="fa fa-laptop"></i>Case Investigators</h3>
                <ol class="breadcrumb">
                    <li><i class="fa fa-home"></i><a href="<?php echo BASE_URL . '/OCS/index.php' ?>">Home</a></li>
                    <li><i class="fa fa-laptop"></i><a href="<?php echo BASE_URL . '/OCS/investigator.php' ?>">Investigtion</a></li>
                </ol>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td> <a href="evidences.php?id=<?= $row['caseId']; ?>"><i class="fa fa-laptop"></i></a></td>
                                    </tr>
                                <?php
                                }
                            } else { ?>
